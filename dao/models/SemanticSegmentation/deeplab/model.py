...
from dao.models.SemanticSegmentation.base import SegmentationModel, SegmentationHead, ClassificationHead
from dao.models.SemanticSegmentation.deeplab.decoder import DeepLabV3Decoder, DeepLabV3PlusDecoder
...
if __name__ == '__main__':
    ...
    print(output.shape)
    model.eval()
    torch.onnx.export(model, x, "/ai/data/deeplabv3.onnx", opset_version=11, input_names=["input"], output_names=["output"])
    ...
    print(output.shape)
    model.eval()
    torch.onnx.export(model, x, "/ai/data/deeplabv3plus.onnx", opset_version=11, input_names=["input"], output_names=["output"])
